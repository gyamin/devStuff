...
$ mongo admin -u nogami -p nogamiPwd
MongoDB shell version: 2.6.8
connecting to: admin

#### リモートから接続
$ mongo 192.168.56.101/admin -u nogami -p nogamiPwd
...
db.system.users.find()
> db.system.users.find()
{ "_id" : "admin.nogami", "user" : "nogami", "db" : "admin", "credentials" : { "MONGODB-CR" : "260191f3425ac346a26897a9501a0d14" }, "roles" : [ { "role" : "userAdminAnyDatabase", "db" : "admin" } ] }
